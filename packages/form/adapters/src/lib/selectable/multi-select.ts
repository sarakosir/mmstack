...
> & {
   ...
   * Useful when multiple validation errors occur (e.g., min/max length combined).
   * (Generated by `injectCreateMultiSelectState` using the validator's `.resolve()` method).
   */
